...
import (
	...
	"github.com/firefly-io/karmada-operator/cmd/webhook/app/options"
	"github.com/firefly-io/karmada-operator/pkg/scheme"
	"github.com/firefly-io/karmada-operator/pkg/webhook/karmada"
)
...
func NewWebhookCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:  "webhook",
		Long: `Start a karmada-operator webhook server`,
...
func Run(opts *options.Options) error {
	...
	hookServer.Register("/mutate-v1alpha1-karmada", &webhook.Admission{Handler: &karmada.MutatingAdmission{}})
