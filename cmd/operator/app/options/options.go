...
import (
	...
	fireflycontrollerconfig "github.com/firefly-io/karmada-operator/cmd/operator/app/config"
...
func NewDefaultComponentConfig() (fireflyctrlmgrconfig.KarmadaOperatorConfiguration, error) {
	internal := fireflyctrlmgrconfig.KarmadaOperatorConfiguration{
