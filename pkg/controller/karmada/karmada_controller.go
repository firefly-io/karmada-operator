...
import (
	...
	"github.com/firefly-io/karmada-operator/pkg/constants"
	operatorclient "github.com/firefly-io/karmada-operator/pkg/generated/clientset/versioned"
	installinformers "github.com/firefly-io/karmada-operator/pkg/generated/informers/externalversions/operator/v1alpha1"
	installlisters "github.com/firefly-io/karmada-operator/pkg/generated/listers/operator/v1alpha1"
	"github.com/firefly-io/karmada-operator/pkg/scheme"
)
...
func (ctrl *KarmadaController) addKarmada(obj interface{}) {
	karmada := obj.(*operatorapi.Karmada)
...
func (ctrl *KarmadaController) updateKarmada(old, cur interface{}) {
	oldKarmada := old.(*operatorapi.Karmada)
	curKarmada := cur.(*operatorapi.Karmada)
...
func (ctrl *KarmadaController) deleteKarmada(obj interface{}) {
	karmada, ok := obj.(*operatorapi.Karmada)
	if !ok {
		...
		karmada, ok = tombstone.Obj.(*operatorapi.Karmada)
		if !ok {
...
func (ctrl *KarmadaController) enqueue(karmada *operatorapi.Karmada) {
...
func (ctrl *KarmadaController) syncKarmada(ctx context.Context, key string) error {
	...
	if karmada.DeletionTimestamp.IsZero() {
		...
		if !controllerutil.ContainsFinalizer(karmada, KarmadaControllerFinalizerName) {
			...
			karmada, err = ctrl.operatorClient.OperatorV1alpha1().Karmadas(karmada.Namespace).Update(ctx, karmada, metav1.UpdateOptions{})
			if err != nil {
				return err
			}
		}
		...
		if controllerutil.ContainsFinalizer(karmada, KarmadaControllerFinalizerName) {
			...
			_, err := ctrl.operatorClient.OperatorV1alpha1().Karmadas(karmada.Namespace).Update(ctx, karmada, metav1.UpdateOptions{})
			if err != nil {
				return err
			}
