...
type KarmadaControllerClientBuilder interface {
	...
	KarmadaFireflyClient(name string) (operatorclient.Interface, error)
	KarmadaFireflyClientOrDie(name string) operatorclient.Interface
}
...
func (b SimpleKarmadaControllerClientBuilder) KarmadaFireflyClient(name string) (operatorclient.Interface, error) {
	clientConfig, err := b.Config(name)
	if err != nil {
		return nil, err
	}
...
// If it gets an error getting the client, it will log the error and kill the process it's running in.
func (b SimpleKarmadaControllerClientBuilder) KarmadaFireflyClientOrDie(name string) operatorclient.Interface {
