...
// LocalEtcd describes that karmada-operator should run an etcd cluster in a host cluster.
...
// karmada-operator has no knowledge of where certificate files live and they must be supplied.
...
type ImageMeta struct {
	...
	// In case this value is set, karmada-operator does not change automatically the version
